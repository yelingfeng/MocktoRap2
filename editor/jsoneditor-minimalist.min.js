  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      var s = n(1),
        ...
        l = n(4)
      ;(i.modes = {}),
        (i.prototype.DEBOUNCE_INTERVAL = 150),
        ...
        (i.prototype.setMode = function (e) {
          ...
          try {
            ...
            if (
              'function' == typeof r.onModeChange &&
              e !== s
            )
              try {
                r.onModeChange(e, s)
        ...
        (i.prototype.setSchema = function (e) {
          if (e) {
            ...
            t &&
              ((this.validateSchema = t.compile(e)),
      ...
      ;(d.create = function (e, t) {
        ...
        (d.set = function (e, t) {
          if (
            ...
            var n = { field: this.options.name, value: e },
              i = new a(this, n)
        ...
        (d.focus = function () {
          var e = this.content.querySelector(
          ...
          e
            ...
            : ((e = this.frame.querySelector('button')),
              e && e.focus())
        }),
        (d.clear = function () {
          this.node &&
        ...
        (d.validate = function () {
          this.errorNodes &&
            this.errorNodes.forEach(function (e) {
              e.setError(null)
            })
          var e = this.node
          if (e) {
            ...
            this.errorNodes = t
              ...
              .map(function (e) {
                return (
                  e.node.setError(e.error, e.child), e.node
                )
              })
          }
        }),
        ...
        (d.startAutoScroll = function (e) {
          var t = this,
            ...
            a = 50
          i + s > e && n.scrollTop > 0
            ? (this.autoScrollStep = (i + s - e) / 3)
            : e > r - s && o + n.scrollTop < n.scrollHeight
            ? (this.autoScrollStep = (r - s - e) / 3)
            ...
            var o = n.clientHeight,
              ...
              a = function () {
                ...
                Math.abs(o) > 3
                  ? ((n.scrollTop += o / 3),
                    (i.animateCallback = t),
                    (i.animateTimeout = setTimeout(a, 50)))
                  : (t && t(!0),
                    (n.scrollTop = s),
                    delete i.animateTimeout,
                    delete i.animateCallback)
        ...
        (d._createFrame = function () {
          ...
          ;(this.frame.onclick = function (t) {
            var n = t.target
            e(t),
              'BUTTON' == n.nodeName && t.preventDefault()
          }),
          ...
          if (
            ...
            this.modeSwitcher = new l(
              ...
              this.options.mode,
              function (e) {
                a.modeSwitcher.destroy(),
                  a.setMode(e),
                  a.modeSwitcher.focus()
              }
            )
          }
          this.options.search &&
            (this.searchBox = new r(this, this.menu))
        }),
        (d._onUndo = function () {
          this.history &&
            (this.history.undo(), this._onChange())
        }),
        (d._onRedo = function () {
          this.history &&
            (this.history.redo(), this._onChange())
        }),
        (d._onEvent = function (e) {
          ...
          if (t && t.selected) {
            ...
            'mousedown' == e.type &&
              a.onDragStart(this.multiselection.nodes, e)
          } else
            'mousedown' == e.type &&
              (this.deselect(),
              t && e.target == t.dom.drag
                ? a.onDragStart(t, e)
                : (!t ||
                    (e.target != t.dom.field &&
                      e.target != t.dom.value &&
                      e.target != t.dom.select)) &&
                  this._onMultiSelectStart(e))
          t && t.onEvent(e)
        }),
        ...
        (d._updateDragDistance = function (e) {
          this.dragDistanceEvent ||
            this._startDragDistance(e)
          var t =
              e.pageX - this.dragDistanceEvent.initialPageX,
            n =
              e.pageY - this.dragDistanceEvent.initialPageY
          return (
        ...
        (d._onKeyDown = function (e) {
          ...
          if (this.searchBox)
            if (n && 70 == t)
              ...
              var s = !0
              i
                ? this.searchBox.previous(s)
                : this.searchBox.next(s),
                (o = !0)
            }
          this.history &&
            (n && !i && 90 == t
        ...
        ;(this.editor = e),
          ...
          (this.actions = {
            ...
            moveNodes: {
              undo: function (e) {
                e.nodes.forEach(function (t) {
                  e.oldBeforeNode.parent.moveBefore(
                    t,
                    e.oldBeforeNode
                  )
                })
              ...
              redo: function (e) {
                e.nodes.forEach(function (t) {
                  e.newBeforeNode.parent.moveBefore(
                    t,
                    e.newBeforeNode
                  )
                })
    ...
    function (e, t, n) {
      ...
      ;(t.parse = function (e) {
        ...
        (t.type = function (e) {
          return null === e
            ...
            : void 0 === e
            ? 'undefined'
            : e instanceof Number || 'number' == typeof e
            ? 'number'
            : e instanceof String || 'string' == typeof e
            ? 'string'
            : e instanceof Boolean || 'boolean' == typeof e
            ? 'boolean'
            : e instanceof RegExp || 'regexp' == typeof e
            ? 'regexp'
            : t.isArray(e)
            ? 'array'
            : 'object'
      ...
      ;(t.isUrl = function (e) {
        ...
        (t.stripFormatting = function (e) {
          for (
            var n = e.childNodes, i = 0, o = n.length;
            o > i;
            i++
          ) {
            var r = n[i]
        ...
        (t.getInnerText = function (e, n) {
          ...
          return 'P' == e.nodeName &&
            -1 != t.getInternetExplorerVersion()
            ? n.flush()
            : ''
        }),
      ...
      ;(t.addEventListener = function (e, n, i, o) {
        ...
        (t.removeEventListener = function (e, n, i, o) {
          e.removeEventListener
            ...
            : e.detachEvent && e.detachEvent('on' + n, i)
        }),
        ...
        (t.improveSchemaError = function (e) {
          if (
            ...
            if (t) {
              ...
              e.message =
                'should be equal to one of: ' + t.join(', ')
            }
          }
          return (
            'additionalProperties' === e.keyword &&
              (e.message =
        ...
        (t.textDiff = function (e, t) {
          for (
            var n = t.length,
              ...
              o = e.length,
              r = t.length;
            t.charAt(i) === e.charAt(i) && n > i;

          )
            i++
          for (
            ;
            t.charAt(r - 1) === e.charAt(o - 1) &&
            r > i &&
            o > 0;
        ...
        var e = {
            ...
            parse: function (e) {
              ...
              for (
                ...
                switch (y[0]) {
                  ...
                  case 2:
                    if (
                      ((x = this.productions_[y[1]][1]),
                      (C.$ = r[r.length - x]),
                      (C._$ = {
                        first_line:
                          s[s.length - (x || 1)].first_line,
                        last_line:
                    ...
                    x &&
                      ...
                      (r = r.slice(0, -1 * x)),
                      (s = s.slice(0, -1 * x))),
                      o.push(this.productions_[y[1]][0]),
                      r.push(C.$),
                      s.push(C._$),
                      (_ =
                        a[o[o.length - 2]][
          ...
          t = (function () {
            var e = {
              ...
              less: function (e) {
                this._input =
                  this.match.slice(e) + this._input
              },
              pastInput: function () {
    ...
    function (e, t) {
      ...
      function n(e, t) {
        ...
        ;(h.type = 'button'),
          (h.className = 'jsoneditor-refresh'),
          (s = document.createElement('td')),
          s.appendChild(h),
          r.appendChild(s)
      ...
      ;(n.prototype.next = function (e) {
        ...
        (n.prototype._setActiveResult = function (e, t) {
          ...
          'field' == r
            ? (o.searchFieldActive = !0)
            : (o.searchValueActive = !0),
            (this.activeResult =
    ...
    function (e, t, n) {
      ...
      function i(e, t) {
            ...
            if ('separator' == o.type) {
              ...
              if (
                ...
                if (o.click) {
                  ...
                  ;(h.type = 'button'),
                    (s.buttonExpand = h),
                    (h.className = 'jsoneditor-expand'),
                    (h.innerHTML =
                      '<div class="jsoneditor-expand"></div>'),
                    a.appendChild(h),
                    o.submenuTitle &&
                      (h.title = o.submenuTitle),
                    (d = h)
                } else {
        ...
        ;(a.className = 'jsoneditor-menu'),
          ...
          (o.items = [])
        var l = document.createElement('button')
        ;(l.type = 'button'), (o.focusButton = l)
        var c = document.createElement('li')
        ;(c.style.overflow = 'hidden'),
          (c.style.height = '0'),
          c.appendChild(l),
          a.appendChild(c),
          n(a, this.dom.items, e),
          (this.maxHeight = 0),
          e.forEach(function (t) {
            var n =
              24 *
              (e.length +
                (t.submenu ? t.submenu.length : 0))
      ...
      ;(i.prototype._getVisibleButtons = function () {
        ...
        (i.prototype.show = function (e, t) {
          ...
          if (t) {
            ...
            r.bottom + this.maxHeight < s.bottom ||
              (r.top - this.maxHeight > s.top && (n = !1))
          }
          if (n) {
          ...
          ;(this.eventListeners.mousedown =
            ...
            i.visibleMenu && i.visibleMenu.hide(),
            (i.visibleMenu = this)
        }),
        ...
        (i.prototype._onKeyDown = function (e) {
          ...
          27 == a
            ? (this.selection &&
                o.setSelection(this.selection),
              this.anchor && this.anchor.focus(),
              this.hide(),
              (l = !0))
            : 9 == a
            ? e.shiftKey
              ? ((t = this._getVisibleButtons()),
                (n = t.indexOf(s)),
                0 == n &&
                  (t[t.length - 1].focus(), (l = !0)))
              : ((t = this._getVisibleButtons()),
                (n = t.indexOf(s)),
                n == t.length - 1 &&
                  (t[0].focus(), (l = !0)))
            : 37 == a
            ? ('jsoneditor-expand' == s.className &&
                ((t = this._getVisibleButtons()),
                (n = t.indexOf(s)),
                (i = t[n - 1]),
                i && i.focus()),
    ...
    function (e, t, n) {
      ...
      function i(e, t) {
        ;(this.editor = e),
          ...
          t && t instanceof Object
            ? (this.setField(t.field, t.fieldEditable),
      ...
      var o = n(9),
        ...
        a = n(4)
      ;(i.prototype.DEBOUNCE_INTERVAL = 150),
        (i.prototype._updateEditability = function () {
          if (
            ...
            'boolean' == typeof e
              ? ((this.editable.field = e),
                (this.editable.value = e))
              : ('boolean' == typeof e.field &&
                  (this.editable.field = e.field),
                'boolean' == typeof e.value &&
                  (this.editable.value = e.value))
          }
        }),
        ...
        (i.prototype.setError = function (e, t) {
          ...
          if (e) {
            ...
            for (
              o.type = 'button',
                o.className = 'jsoneditor-schema-error',
                o.appendChild(i),
                o.onmouseover = o.onfocus =
                  function () {
                    for (
                      var e = [
                          'right',
                      ...
                      var n = e[t]
                      i.className =
                        'jsoneditor-popover jsoneditor-' + n
                      var o =
            ...
            for (var l in e)
              e.hasOwnProperty(l) &&
                ...
                void 0 === n ||
                  ...
                  this.appendChild(o)))
            ;(this.value = ''),
              this.editor.options.sortObjectKeys === !0 &&
                this.sort('asc')
          ...
          if (e && this.expanded) {
            ...
            if (n) {
              var i = this.getAppend(),
                o = t.nextSibling
              o ? n.insertBefore(i, o) : n.appendChild(i),
                this.childs.forEach(function (e) {
                  n.insertBefore(e.getDom(), i),
                    e.showChilds()
                })
            }
          }
        ...
        (i.prototype.scrollTo = function (e) {
          if (!this.dom.tr || !this.dom.tr.parentNode)
            for (var t = this.parent, n = !1; t; )
              t.expand(n), (t = t.parent)
          this.dom.tr &&
            this.dom.tr.parentNode &&
            this.editor.scrollTo(this.dom.tr.offsetTop, e)
        }),
        (i.focusElement = void 0),
          ...
          if (
            ...
            switch (e) {
              ...
              case 'expand':
                this._hasChilds()
                  ? t.expand.focus()
                  : t.field && this.fieldEditable
                  ? (t.field.focus(),
                    a.selectContentEditable(t.field))
                  : t.value && !this._hasChilds()
                  ? (t.value.focus(),
                    a.selectContentEditable(t.value))
                  : t.menu.focus()
                break
              case 'field':
                t.field && this.fieldEditable
          ...
          if (t != e) {
            if (
              ...
              n = this.expanded
                ...
                : this.getDom()
              var o =
                n && n.parentNode ? n.nextSibling : void 0
              this.hide(),
                this.clearDom(),
                (this.type = e),
                'object' == e
        ...
        (i.prototype._getDomValue = function (e) {
          if (
            (this.dom.value &&
              'array' != this.type &&
              'object' != this.type &&
              (this.valueInnerText = a.getInnerText(
                this.dom.value
              )),
        ...
        (i.prototype._updateDomValue = function () {
          ...
          if (e) {
            var t = ['jsoneditor-value'],
              n = this.value,
              i =
                'auto' == this.type ? a.type(n) : this.type,
            ...
            var r =
              ...
              'object' != this.type
            if (
              (r && t.push('jsoneditor-empty'),
              this.searchValueActive &&
                t.push('jsoneditor-highlight-active'),
              this.searchValue &&
                t.push('jsoneditor-highlight'),
              (e.className = t.join(' ')),
              'array' == i || 'object' == i)
            ) {
              var s = this.childs ? this.childs.length : 0
              e.title =
                this.type + ' containing ' + s + ' items'
            } else
              o && this.editable.value
                ? (e.title =
              ...
              if (!this.dom.select) {
                ...
                for (
                  ...
                  (this.dom.select.option =
                    ...
                    this.dom.select.option.value ==
                      this.value &&
                      (this.dom.select.option.selected =
                        !0),
                    this.dom.select.appendChild(
                      this.dom.select.option
                    )
        ...
        (i.prototype._updateDomField = function () {
          ...
          if (e) {
            ...
            t
              ? a.addClassName(e, 'jsoneditor-empty')
              ...
              this.searchField
                ? a.addClassName(e, 'jsoneditor-highlight')
                : a.removeClassName(
                    e,
        ...
        (i.prototype._getDomField = function (e) {
          if (
            (this.dom.field &&
              this.fieldEditable &&
              (this.fieldInnerText = a.getInnerText(
                this.dom.field
              )),
            void 0 != this.fieldInnerText)
          )
            try {
              var t = this._unescapeHTML(
                this.fieldInnerText
              )
              t !== this.field &&
                ((this.field = t),
        ...
        (i.prototype.validate = function () {
          ...
          if ('object' === this.type) {
            for (
              ...
              var o = this.childs[i]
              t.hasOwnProperty(o.field) && n.push(o.field),
                (t[o.field] = !0)
            }
            n.length > 0 &&
              (e = this.childs
        ...
        (i.onDragStart = function (e, t) {
          ...
          if (0 !== e.length) {
            var n = e[0],
              ...
              l = n.editor,
              c =
                a.getAbsoluteTop(r.dom.tr) -
                a.getAbsoluteTop(n.dom.tr)
            l.mousemove ||
            ...
            if (
              ...
              do
                (o = o.previousSibling),
                  ...
                  (f = o ? a.getAbsoluteTop(o) : 0)
              while (o && f > w)
              h && !h.parent && (h = void 0),
                h ||
                  ((d = n.parentNode.firstChild),
              ...
              if (
                ((c =
                  C.expanded && C.append
                    ? C.append.getDom()
                    : C.dom.tr),
                (s = c ? c.nextSibling : void 0))
              ) {
                ;(m = a.getAbsoluteTop(s)), (r = s)
                do
                  (u = i.getNodeFromTarget(r)),
                    r &&
                      ((v = r.nextSibling
                        ? a.getAbsoluteTop(r.nextSibling)
                        : 0),
                      (y = r ? v - m : 0),
                      u.parent.childs.length == e.length &&
                        u.parent.childs[e.length - 1] ==
                          C &&
                        (p += 27)),
                    (r = r.nextSibling)
                while (r && w > p + y)
                  ...
                  for (
                    ...
                    if (A);
                      ...
                      if (
                        ...
                        break
                      ;(u = i.getNodeFromTarget(o)),
                        (k = u.getLevel())
                    }
                    o = o.previousSibling
                  }
                  c.nextSibling != u.dom.tr &&
                    (e.forEach(function (e) {
        ...
        (i.prototype.updateDom = function (e) {
          ...
          if (n) {
            this.fieldEditable
              ? ((n.contentEditable = this.editable.field),
                (n.spellcheck = !1),
                (n.className = 'jsoneditor-field'))
              : (n.className = 'jsoneditor-readonly')
            var i
            ;(i =
              void 0 != this.index
                ? this.index
                ...
                ? this.type
                : ''),
              (n.innerHTML = this._escapeHTML(i)),
              this._updateSchema()
          }
        ...
        (i.prototype._updateSchema = function () {
          this.editor &&
            this.editor.options &&
            ((this.schema = i._findSchema(
              this.editor.options.schema,
              this.getPath()
            )),
            this.schema
              ? (this['enum'] = i._findEnum(this.schema))
              : delete this['enum'])
        }),
        ...
        (i._findSchema = function (e, t) {
          for (var n = e, i = 0; i < t.length && n; i++) {
            var o = t[i]
            'string' == typeof o && n.properties
              ? (n = n.properties[o] || null)
              : 'number' == typeof o &&
                n.items &&
                (n = n.items)
          }
        ...
        (i.prototype._createDomExpandButton = function () {
          ...
          return (
            (e.type = 'button'),
            this._hasChilds()
              ? ((e.className = this.expanded
                  ? 'jsoneditor-expanded'
                  : 'jsoneditor-collapsed'),
                (e.title =
                  'Click to expand/collapse this field (Ctrl+E). \nCtrl+Click to expand/collapse including all childs.'))
              : ((e.className = 'jsoneditor-invisible'),
                (e.title = '')),
            e
          )
        }),
        ...
        (i.prototype.onEvent = function (e) {
          ...
          if (
            'click' == t &&
            (n == i.expand ||
              (('view' === o.editor.options.mode ||
                'form' === o.editor.options.mode) &&
                'DIV' === n.nodeName)) &&
            r
          ) {
            var l = e.ctrlKey
          ...
          if (
            ...
            var u =
              void 0 != e.offsetX
                ? e.offsetX < 24 * (this.getLevel() + 1)
                : e.pageX < a.getAbsoluteLeft(i.tdSeparator)
            u || r
              ? d &&
                (a.setEndOfContentEditable(d), d.focus())
              : c &&
                !this['enum'] &&
        ...
        (i.prototype.onKeyDown = function (e) {
          ...
          if (13 == u) {
            ...
            f && y && (i.onDuplicate(b), (v = !0))
          else if (69 == u)
            f && (this._onExpand(m), p.focus(), (v = !0))
          else if (77 == u && y)
            f && (this.showContextMenu(p), (v = !0))
          else if (46 == u && y)
            f && (i.onRemove(b), (v = !0))
          else if (45 == u && y)
            f && !m
              ? (this._onInsertBefore(), (v = !0))
              : f && m && (this._onInsertAfter(), (v = !0))
          else if (35 == u) {
            if (g) {
              var C = this._lastNode()
              C &&
                C.focus(
                  i.focusElement || this._getElementName(p)
                ),
                (v = !0)
            }
          } else if (36 == u) {
            ...
            if (g && !m) {
              ...
              j && this.focus(this._getElementName(j)),
                (v = !0)
            } else if (g && m && y) {
              if (x.expanded) {
                var N = x.getAppend()
              ...
              o &&
                ((n = i.getNodeFromTarget(o)),
                (r = o.nextSibling),
                (T = i.getNodeFromTarget(r)),
                n &&
                  n instanceof l &&
                  1 != x.parent.childs.length &&
                  T &&
                  T.parent &&
            ...
            g && !m
              ...
              ? ((t = this._previousNode()),
                t &&
                  ((h = this.editor.multiselection),
                  (h.start = h.start || this),
                  (h.end = t),
                  (d = this.editor._findTopLevelNodes(
                    h.start,
                    h.end
                  )),
            ...
            if (g && !m) {
              ...
              A && this.focus(this._getElementName(A)),
                (v = !0)
            } else if (g && m && y) {
              k = w.getDom()
              var O = k.previousSibling
              O &&
                ((t = i.getNodeFromTarget(O)),
                t &&
                  t.parent &&
                  t instanceof l &&
                  !t.isVisible() &&
        ...
        (i.prototype.sort = function (e) {
          if (this._hasChilds()) {
            ...
            ;(this.childs = this.childs.concat()),
              this.childs.sort(function (e, i) {
                return t * o(e[n], i[n])
              }),
              (this.sortOrder = 1 == t ? 'asc' : 'desc'),
        ...
        (i.blurNodes = function (e) {
          if (!Array.isArray(e))
            return void i.blurNodes([e])
          var t = e[0],
            n = t.parent,
            o = t.getIndex()
          n.childs[o + e.length]
            ? n.childs[o + e.length].focus()
            : n.childs[o - 1]
            ? n.childs[o - 1].focus()
            : n.focus()
        }),
        (i.prototype._nextSibling = function () {
          ...
          return (
            this.parent.childs[e + 1] || this.parent.append
          )
        }),
        (i.prototype._previousNode = function () {
          ...
          if (t && t.parentNode) {
            ...
            while (n && e instanceof l && !e.isVisible())
          }
          return e
        }),
        ...
        (i.prototype._getType = function (e) {
          return e instanceof Array
            ...
            ? 'object'
            : 'string' == typeof e &&
              'string' != typeof this._stringCast(e)
            ? 'string'
            : 'auto'
        }),
        ...
        (i.prototype._escapeHTML = function (e) {
          ...
          return (
            this.editor.options.escapeUnicode === !0 &&
      ...
      e.exports = function n(e, t) {
        ...
        var i,
          ...
          f = u
            ...
            .split('\x00'),
          m =
            parseInt(h.match(l), 16) ||
            (1 !== p.length && h.match(a) && Date.parse(h)),
          g =
            parseInt(u.match(l), 16) ||
            (m && u.match(a) && Date.parse(u)) ||
            null
        if (g) {
          if (g > m) return -1
          if (m > g) return 1
        ...
        for (
          var v = 0, y = Math.max(p.length, f.length);
          y > v;
          v++
        ) {
          if (
      ...
      function i(e) {
        ...
        return (
          ...
          (t.prototype.updateDom = function () {
            ...
            this.isVisible()
              ? e.tr.firstChild ||
                (e.tdDrag && i.appendChild(e.tdDrag),
                e.tdMenu && i.appendChild(e.tdMenu),
                i.appendChild(t))
              : e.tr.firstChild &&
                (e.tdDrag && i.removeChild(e.tdDrag),
                e.tdMenu && i.removeChild(e.tdMenu),
                i.removeChild(t))
          }),
    ...
    function (e, t, n) {
      ...
      function i(e, t, n, i) {
        ...
        ;(p.className = 'jsoneditor-modes'),
          (p.style.position = 'relative'),
          p.appendChild(u),
          e.appendChild(p),
          (this.dom = { container: e, box: u, frame: p })
      }
      var o = n(7)
    ...
    function (e, t, n) {
      ...
      var r = n(11),
        ...
        a = {},
        l = 3,
        c = 'ace/theme/jsoneditor'
      ;(a.create = function (e, t) {
        ;(t = t || {}),
          (this.options = t),
          t.indentation
            ? (this.indentation = Number(t.indentation))
            : (this.indentation = 2)
        var o = t.ace ? t.ace : i
        ;(this.mode = 'code' == t.mode ? 'code' : 'text'),
          ...
          (this.theme = t.theme || c),
          this.theme === c && window.ace && n(17)
        var a = this
        ;(this.container = e),
          (this.dom = {}),
          ...
          (this.validateSchema = null),
          (this._debouncedValidate = s.debounce(
            this.validate.bind(this),
            this.DEBOUNCE_INTERVAL
          )),
        ...
        if (
          ((d.type = 'button'),
          (d.className = 'jsoneditor-compact'),
          (d.title =
          ...
          u.appendChild(
            ...
            h.on('change', this._onChange.bind(this))
        } else {
        ...
        (a.set = function (e) {
          this.setText(
            JSON.stringify(e, null, this.indentation)
          )
        }),
        (a.get = function () {
          var e,
        ...
        (a.setText = function (e) {
          ...
          if (
            ((t =
              this.options.escapeUnicode === !0
                ? s.escapeUnicodeChars(e)
                : e),
        ...
        (a.validate = function () {
          ...
          if (t && this.validateSchema) {
            ...
            o ||
              (n = this.validateSchema.errors.map(function (
                e
              ) {
          ...
          if (n.length > 0) {
            ...
            ;(c.innerHTML =
              ...
              n
                ...
                .join('') +
              '</tbody></table>'),
              (this.dom.validationErrors = c),
              this.frame.appendChild(c)
            var d = c.clientHeight
            ;(this.content.style.marginBottom = -d + 'px'),
              (this.content.style.paddingBottom = d + 'px')
          }
          if (this.aceEditor) {
            var h = !1
                  ...
                  function (e, t, n, o, r) {
                    ...
                    if ('{' == r) {
                      ...
                      if (
                        ...
                        return u(c, d, '{', '}')
                      if (p.isSaneInsertion(n, o))
                        return /[\]\}\)]/.test(
                          l[s.column]
                        ) || n.inMultiSelectMode
                          ? (p.recordAutoInsert(n, o, '}'),
                            {
                              text: '{}',
                              selection: [1, 1],
                            })
                    ...
                    function (e, t, n, i, o) {
                      if ('(' == o) {
                        ...
                        if (
                          ...
                          return u(r, s, '(', ')')
                        if (p.isSaneInsertion(n, i))
                          return (
                            p.recordAutoInsert(n, i, ')'),
                            {
                              text: '()',
                              selection: [1, 1],
                            }
                      ...
                      if ('"' == o || "'" == o) {
                        ...
                        if (!a) {
                          ...
                          var g,
                            v =
                              f &&
                              /string|escape/.test(f.type),
                            y =
                              !m ||
                              /string|escape/.test(m.type)
                          if (p == r) g = v !== y
                          else {
                            if (v && !y) return null
                            if (v && y) return null
            ...
            ;(p.isSaneInsertion = function (e, t) {
              ...
              (p.recordAutoInsert = function (e, t, n) {
                ...
                this.isAutoInsertedClosing(
                  ...
                  (i.autoInsertedRow = o.row),
                  (i.autoInsertedLineEnd =
                    n + r.substr(o.column)),
              ...
              (p.recordMaybeInsert = function (e, t, n) {
                var o = e.getCursorPosition(),
                  r = t.doc.getLine(o.row)
                this.isMaybeInsertedClosing(o, r) ||
                  (i.maybeInsertedBrackets = 0),
                  (i.maybeInsertedRow = o.row),
                  (i.maybeInsertedLineStart =
                    r.substr(0, o.column) + n),
                  (i.maybeInsertedLineEnd = r.substr(
                    o.column
                  )),
                  i.maybeInsertedBrackets++
              }),
              (p.isAutoInsertedClosing = function (
                e,
                t,
                n
              ) {
              ...
              (p.popAutoInsertedClosing = function () {
                ;(i.autoInsertedLineEnd =
                  i.autoInsertedLineEnd.substr(1)),
                  i.autoInsertedBrackets--
              }),
              ...
              function () {
                ;(this.foldingStartMarker =
                  ...
                  (this.getFoldWidget = function (e, t, n) {
                    var i = e.getLine(n)
                    if (
                      this.singleLineBlockCommentRe.test(
                        i
                      ) &&
                    ...
                    return !o && this.startRegionRe.test(i)
                      ? 'start'
                      : o
                  }),
          ...
          ;(function () {
            ;(this.setEditor = function (e) {
              ...
              (this.$initElements = function (e) {
                ;(this.searchBox = e.querySelector(
                  '.ace_search_form'
                )),
                  (this.replaceBox = e.querySelector(
                    '.ace_replace_form'
                  )),
              ...
              (this.$init = function () {
                ...
                r.addListener(e, 'mousedown', function (e) {
                  ...
                  r.addListener(e, 'click', function (e) {
                    ...
                    i && t[i]
                      ? t[i]()
                      : t.$searchBarKb.commands[i] &&
                        t.$searchBarKb.commands[i].exec(t),
                      r.stopPropagation(e)
                  }),
                  r.addCommandKeyListener(
                    e,
                    function (e, n, i) {
                      var o = l.keyCodeToString(i),
                        s = t.$searchBarKb.findKeyCommand(
                          n,
                          o
                        )
                      s &&
                        s.exec &&
                        (s.exec(t), r.stopEvent(e))
                    }
                  ),
                  (this.$onChange = o.delayedCall(
                    function () {
                      t.find(!1, !1)
                    }
                  )),
              ...
              (this.show = function (e, t) {
                ;(this.element.style.display = ''),
                  (this.replaceBox.style.display = t
                    ? ''
                    : 'none'),
                  (this.isReplace = t),
